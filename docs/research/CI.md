> **Archive / historical context:** Checklist from an earlier repo layout. **Current product:** Roster MCP · Maslow AI · npm `@maslowai/roster`. Package and org names below (e.g. `@sparesparrow/*`) are **historical** references inside this artifact.
