# Release summary — v3.14.0 (Roster MCP / Maslow AI)

The product is published as **`@maslowai/roster`**. Legacy prose may refer to earlier package names.
...
```
File Storage (`./data/prompts` in this repository)
...
File Storage (custom `PROMPTS_DIR`)
✅ Server startup: SUCCESS
